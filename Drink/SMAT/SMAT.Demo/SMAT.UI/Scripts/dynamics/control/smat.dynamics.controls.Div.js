...
(function () {
    ...
    smat.dynamics.Div.prototype = {
        ...
        init: function () {
            ...
            this.body = $('<div id="' + this.getUiId() + '"  class="form-horizontal s-div ' + designClass + this.getClassStr() + '" style="width: 100%;float: left;' + this.getStyleStr() + '"></div>').appendTo(contextOn);
