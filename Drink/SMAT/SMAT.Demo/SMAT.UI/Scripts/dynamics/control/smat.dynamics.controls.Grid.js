    ...
    smat.dynamics.Grid.prototype = {
        ...
        initCustomEditSkin: function () {
            ...
            if (pageTemplate.config.type == "SimpleCrossStatistic") {
                ...
                $('<div class="" drop-type="xField" style="background-color: #DBDCF9;opacity: 0.6;position: absolute;top: -1px;left: -1px;width: 100%;height:100%;"></div>').appendTo(this.yFieldBox);
                ...
                $('<div class="" drop-type="xField" style="background-color: #EEF7C2;opacity: 0.6;position: absolute;top: -1px;left: -1px;width: 100%;height:100%;"></div>').appendTo(this.vFieldBox);
