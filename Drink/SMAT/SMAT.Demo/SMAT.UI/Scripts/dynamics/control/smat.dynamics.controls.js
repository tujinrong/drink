    ...
    smat.dynamics.Control.prototype = {
        ...
        getContextMenuConfig: function () {
            ...
            this.contextMenuConfig = [
			    {
			        group: 'base',
			        text: '<span class="menu-item" dy-uuid="' + this.uuid + '" menu-key="del">del</span>',
			        encoded: false,
			        id: 'del',
			        cmt: 'del'
			    }
           ...
           getUiId: function () {
               var id = this.config.page.config.entityName + "_" + this.config.page.config.name + "_" + this.config.name;
