(function () {
	...
	smat.dynamics.ProjectManager.prototype = {
	    ...
	    init: function () {
           ...
           // this.rowtoolBar = $('<div class="row" style="margin: 3px 0 0 0;"><button id="designer_projectManager_search_btn" class="btn-dark s-button" style="margin-left:5px;"><i class="icon-reload"></i>　リフレッシュ</button></div>').appendTo(this.toolBarContent);
            ...
            //this.saveBtn = $('<button  class="btn-dark s-button" style="margin-left:5px;"><i class="fa fa-save"></i>　保存</button>').appendTo(this.rowtoolBar);
            //this.designBtn = $('<button  class="btn-dark s-button" style="margin-left:5px;"><i class="fa fa-edit"></i>　デザイン</button>').appendTo(this.rowtoolBar);
            //this.savForeBtn = $('<button  class="btn-dark s-button" style="margin-left:5px;"><i class="fa fa-save"></i>　名前付けで保存</button>').appendTo(this.rowtoolBar);
            //this.delBtn = $('<button class="btn-dark s-button" style="margin-left:5px;"><i class="fa fa-trash-o"></i>　削除</button>').appendTo(this.rowtoolBar);
            //this.closeBtn = $('<button class="btn-dark s-button" style="margin-left:5px;"><i class="fa fa-times"></i>　閉じる</button>').appendTo(this.rowtoolBar);
            ...
            smat.service.loadJosnData({
                ...
                success: function (result) {
                    ...
                    treeData[0].items[0].items = [];
                    for (var i in result) { 
                        treeData[0].items[0].items.push({
                            text: result[i].EntityDesc,
                            value: "entity",
                            dataKey: result[i].EntityName,
                            items: [
                                { text: smat.service.optionSet("DyOptionText.Field"), value: "field", dataKey: result[i].EntityName },
                                { text: smat.service.optionSet("DyOptionText.1NRela"), value: "rela1N", dataKey: result[i].EntityName },
                                { text: smat.service.optionSet("DyOptionText.N1Rela"), value: "relaN1", dataKey: result[i].EntityName },
                    ...
                    self.treeview.setDataSource(treeData);
