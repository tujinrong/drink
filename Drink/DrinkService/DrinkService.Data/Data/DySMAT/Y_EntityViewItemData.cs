    ...
    public class Y_EntityViewItemData
    {
        ...
        public static Y_EntityViewItem[] GetData()
        {
            ...
            return new Y_EntityViewItem[] {
                //補充集金指示リスト
                new Y_EntityViewItem {ProjID =1, EntityName =typeof(T_HoOrderClient).Name, ViewName=Y_EntityViewData.補充集金指示リスト,
                    ItemName ="状態", Seq =0, ItemDesc ="状態",
                    Path= "",
                    ItemEntityName=typeof(T_HoOrderClient).Name, 
                    ItemSql=typeof(T_HoOrderClient).Name +"." + T_HoOrderClient.I済フラグ,
                    Format="=Name("+ModelBase.CN済 +")",
                    Width ="10" } ,
                new Y_EntityViewItem {ProjID =1, EntityName =typeof(T_HoOrderClient).Name, ViewName=Y_EntityViewData.補充集金指示リスト, 
                    ItemName ="初回", Seq =1, ItemDesc ="初回", 
                    Path= "",
                    ItemEntityName=typeof(T_HoOrderClient).Name, 
                    ItemSql=typeof(T_HoOrderClient).Name +"." + T_HoOrderClient.I初回フラグ,
                    Format="=Name("+ModelBase.CN初回 +")",
                    Width ="10" } ,
                new Y_EntityViewItem {ProjID =1, EntityName =typeof(T_HoOrderClient).Name, ViewName=Y_EntityViewData.補充集金指示リスト, 
                ...
                //補充集金リスト
                new Y_EntityViewItem {ProjID =1, EntityName =typeof(T_HoClient).Name, ViewName=Y_EntityViewData.補充集金リスト, 
                    ItemName ="担当者", Seq =2, ItemDesc ="担当者", 
                ...
                new Y_EntityViewItem {ProjID =1, EntityName =typeof(T_HoClient).Name, ViewName=Y_EntityViewData.補充集金リスト, 
                    ...
                    ItemEntityName=typeof(T_HoClient).Name, 
                    EntityAlias=typeof(T_HoClient).Name,
                    ItemSql=typeof(T_HoClient).Name + "." + T_HoClient.I集金額, 
                    Width ="10" } ,
               ...
               //担当者一覧
               new Y_EntityViewItem {ProjID =1, EntityName =typeof(M_Staff).Name, ViewName=Y_EntityViewData.担当者一覧, 
                    ItemName ="店舗", Seq =4, ItemDesc ="店舗", 
                    Path="N1:" + typeof(M_Staff).Name + "." + Y_EntityRelaN1Data.rM_SHOP ,
                    ItemEntityName=typeof(M_Shop).Name, 
                    EntityAlias=typeof(M_Shop).Name,
               ...
               new Y_EntityViewItem {ProjID =1, EntityName =typeof(M_Staff).Name, ViewName=Y_EntityViewData.担当者一覧, 
                ...
                new Y_EntityViewItem {ProjID =1, EntityName =typeof(M_Staff).Name, ViewName=Y_EntityViewData.担当者一覧, 
                    ...
                    //店舗一覧
                new Y_EntityViewItem {ProjID =1, EntityName =typeof(M_Shop).Name, ViewName=Y_EntityViewData.店舗一覧, 
                ...
                new Y_EntityViewItem {ProjID =1, EntityName =typeof(M_Shop).Name, ViewName=Y_EntityViewData.店舗一覧, 
                    ...
                    ItemEntityName=typeof(M_Shop).Name, 
                    EntityAlias=typeof(M_Shop).Name,
                    ItemSql=typeof(M_Shop).Name + "." + M_Shop.CN店舗業務区分, 
               ...
               //顧客一覧
                new Y_EntityViewItem {ProjID =1, EntityName =typeof(M_Client).Name, ViewName=Y_EntityViewData.顧客一覧, 
                    ItemName ="店舗コード", Seq =1, ItemDesc ="コード", 
                    Path="",
                    ItemEntityName=typeof(M_Client).Name, 
                    EntityAlias=typeof(M_Client).Name,
                    OrderBy=1,
                    ItemSql=typeof(M_Client).Name + "." + M_Client.I店舗コード, 
                    Width ="10" } ,
                new Y_EntityViewItem {ProjID =1, EntityName =typeof(M_Client).Name, ViewName=Y_EntityViewData.顧客一覧, 
                    ItemName ="顧客コード", Seq =2, ItemDesc ="顧客コード", 
                    Path="",
                    ItemEntityName=typeof(M_Client).Name, 
                    EntityAlias=typeof(M_Client).Name,
                    ItemSql=typeof(M_Client).Name + "." + M_Client.I顧客コード, 
                    Width ="10" } ,
                new Y_EntityViewItem {ProjID =1, EntityName =typeof(M_Client).Name, ViewName=Y_EntityViewData.顧客一覧, 
                    ItemName ="顧客名", Seq =2, ItemDesc ="顧客名", 
                    Path="",
                    ItemEntityName=typeof(M_Client).Name, 
                    EntityAlias=typeof(M_Client).Name,
                    ItemSql=typeof(M_Client).Name + "." + M_Client.I顧客名, 
                ...
                //集計表
                new Y_EntityViewItem {ProjID =1, EntityName =typeof(T_HoClient).Name, ViewName=Y_EntityViewData.補充集金集計表, 
                    ItemName ="担当者", Seq =2, ItemDesc ="担当者", 
                    Path="N1:" + typeof(T_HoClient).Name + "." + Y_EntityRelaN1Data.rM_STAFF ,
                    ItemEntityName=typeof(M_Staff).Name, 
                    EntityAlias=typeof(M_Staff).Name,
