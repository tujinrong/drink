...
namespace DrinkService.Controllers
{
    public class DynamicsController : BaseController
    {
        ...
        public ActionResult FormPage(int ProjID, string EntityName, string FormName,string FormDesc, string type)
        {
            ViewBag.ProjID = ProjID;
            ViewBag.FormName = FormName;
            ViewBag.FormDesc = FormDesc;
            ViewBag.EntityName = EntityName;
            ViewBag.type = type;

            //ViewBag.id = "_" + ProjID + "_" + EntityName + "_" + FormName;
            ViewBag.id =DateTime.Now.ToString("yyyyMMddHHmmssffff");
        ...
        public JsonResult GetEntity(int ProjID, string EntityName)
        {
            ...
            Y_Entity entity = logic.GetEntity(ProjID, EntityName);
            //entity.ViewList = new List<Y_EntityView>();
        ...
        public JsonResult DataExportToExcel(DynamicsViewRequest request, DataExportSetting dataExportSetting)
        {
            ...
            request.GetPageSize = 2147483647;
            ...
            if (result.ResultType == "Success")
            {
                ...
                string fileName = request.ViewName;
                ...
                resourcesDataItem.Add("ResourcesName", request.ViewName);
        ...
        public JsonResult ItemDataImport(string ResourcesID, DataImportSetting dataImportSetting, string FromEntityName, string FromFormName)
        {
            DataImportResult result = new DataImportResult();
            ...
            if (resourceDT.Rows.Count > 0)
            {
                ...
                if (System.IO.File.Exists(physicalPath))
                {
                    ...
                    result = DataIOUtils.ItemDataImport(dataImportSetting);
                }
            }
            else
            {
