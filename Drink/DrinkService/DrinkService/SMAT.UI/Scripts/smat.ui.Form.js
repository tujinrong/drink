    ...
    smat.Form.prototype = {
                        ...
                        if (btn.length > 0) {
                            ...
                            btn.bind("click", function (e) {
                                ...
                                if (confirmMsg != "") {
                                    ...
                                    if (btnActionInfo.ignoreCommonCheck == undefined || btnActionInfo.ignoreCommonCheck == false) {
                                        if (btnActionInfo.dyAction != "del" && smat.service.doCommonCheck($(self.config.target)) == false) {
                                            return false;
                                        }
                                    }

                                    if (btnActionInfo != undefined && btnActionInfo.checkForm != undefined) {
                                        couCheck = self.trigger(btnActionInfo.checkForm);
                                    } else if (self.config.checkForm != undefined) {
                                        couCheck = self.trigger(self.config.checkForm);
                                    }

                                    //for flow handle
                                    if (btnActionInfo && btnActionInfo.otherCheckForm) {
                                        couCheck = couCheck && btnActionInfo.otherCheckForm() == true;
                                    }
        ...
        doAction: function (actionInfo) {
            ...
            if (actionInfo.ignoreCommonCheck == undefined || actionInfo.ignoreCommonCheck == false) {
                if (actionInfo.dyAction != "del" && smat.service.doCommonCheck($(this.config.target)) == false) {
                    return false;
                }
            }
            ...
            if (actionInfo && actionInfo.otherCheckForm) {
                couCheck = couCheck && actionInfo.otherCheckForm() == true;
            }
                    ...
                    if (result != undefined && result.ReturnValue != undefined) {
                        ...
                        if (type == "haita" || type == "keyExist" || type == "checkDelete") {
                            ...
                            if (type == "haita") {
                                ...
                                if (!msg)msg = smat.service.optionSet("SysMsg.AssociatedDataExist");
                            }
