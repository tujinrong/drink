...
(function () {
    ...
    smat.dynamics.property.Filter.prototype = {
        ...
        initEditer: function () {
            ...
            if (!this.entity) this.entity = this.config.page.entity;
        ...
        open: function () {
            ...
            //==================Field==============
            var entityData = (self.editEntity) ? self.editEntity : this.entity;
            var fieldData = smat.dynamics.entityFieldTree(entityData, "");
            ...
            var entityData = (this.editEntity) ? this.editEntity : this.entity;

            for (var key in entityData.FieldList) {
                var item = smat.globalObject.clone(entityData.FieldList[key]);
                ...
                afterClose: function (result) {
                    ...
                    if (result != undefined) {
                        ...
                        if (self.config.mode == "edit") {
                            ...
                            var en = (self.editEntity) ? self.editEntity.EntityName : self.entity.EntityName;
                            var filterControl = $.Enumerable.From(self.config.page.entity.FilterControlList).Where("$.FilterControlName == '" + self.config.oldFilterName + "' && $.EntityName =='" + en + "'").ToArray()[0];
                            var filter = $.Enumerable.From(self.config.page.entity.FilterList).Where("$.FilterName == '" + self.config.oldFilterName + "' && $.EntityName =='" + en + "'").ToArray()[0];
                        ...
                        if (self.config.mode == "new") {
                            var filterControl = {
                                ...
                                EntityName: (self.editEntity) ? self.editEntity.EntityName : self.entity.EntityName,
            ...
            if (this.config.currentDataItem != undefined && this.config.currentDataItem.value != "") {
                ...
                var en = (self.editEntity) ? self.editEntity.EntityName : self.entity.EntityName;
                this.filter = $.Enumerable.From(this.config.page.entity.FilterList).Where("$.FilterName == '" + this.config.currentDataItem.value + "' && $.EntityName =='" + en + "'").ToArray()[0];
                this.setProInfo();
            }
            ...
            if (this.config.filterName != undefined) {
                ...
                var en = (self.editEntity) ? self.editEntity.EntityName : self.entity.EntityName;
                this.filter = $.Enumerable.From(this.config.page.entity.FilterList).Where("$.FilterName == '" + this.config.filterName + "' && $.EntityName =='" + en + "'").ToArray()[0];
                this.setProInfo();
            }
            ...
            $.each(dragItems, function (n, value) {
                ...
                $(this).asmatDraggable({
                    ...
                    hint: function (item) {
                        ...
                        self.propertyBox.append('<div class="property-drop-hint-box" style="position: absolute;background-color: #19C6F9;opacity: 0.2;text-align: center;top: -1px;left: -1px;width: 100%;height: 100%;z-index: 1099; display: block;"><span style="position: absolute;top: 30%;display: block;left: 135px;color: #fff;font-size: 36px;font-weight: bold;"></span></div>');
            ...
            this.propertyBox.asmatDropTargetArea({
                ...
                drop: function (e) {
                    ...
                    self.filter = {
                        ProjID: self.config.page.config.projID,
                        EntityName: (self.editEntity) ? self.editEntity.EntityName : self.config.page.config.entityName,
