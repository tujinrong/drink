...
(function () {
    ...
    smat.dynamics.property.LogicStr = function (config) {
        //默认属性
        this.setConfig({
            picker: undefined,
        });
    ...
    smat.dynamics.property.LogicStr.prototype = {
        /**
           * 初期化
           * @name init
        ...
        init: function () {
            ...
            this.btn_ok.bind('click', function () {
                ...
                var value = self.logicHandler.jsCode();
...
+'</section>'
    ...
    // extend Node
    smat.globalObject.extend(smat.dynamics.property.LogicStr, smat.dynamics.Element);
})();