            ...
            this.treeData = [
                {
                    ...
                    imageUrl: "/SMAT.UI/images/folder_web.png",
                    items: [
                        {
                            id: 1,
                            text: smat.service.optionSet("DyOptionText.Entity"),
                            imageUrl: "/SMAT.UI/images/box.png",
                            value: "entityList"
                        },
                        {
                            id: 2,
                            text: smat.service.optionSet("DyOptionText.OptionSet"),
                            imageUrl: "/SMAT.UI/images/topic_option.png",
                            value: "optionSet"
                        },
                        //{
                        //    id: 3,
                        ...
                        },
                        {
                            ...
                            imageUrl: "/SMAT.UI/images/database_option.png",
                ...
                success: function (result) {
                    ...
                    for (var i in result) {
                        self.treeData[0].items[0].items.push({
                            ...
                            imageUrl: "/SMAT.UI/images/table_edit.png",
                            value: "entity",
                            dataKey: result[i].EntityName,
                            items: [
                                { text: smat.service.optionSet("DyOptionText.Field"), imageUrl: "/SMAT.UI/images/text-field.png", value: "field", dataKey: result[i].EntityName },
                                { text: smat.service.optionSet("DyOptionText.1NRela"), imageUrl: "/SMAT.UI/images/link.png", value: "rela1N", dataKey: result[i].EntityName },
                                { text: smat.service.optionSet("DyOptionText.N1Rela"), imageUrl: "/SMAT.UI/images/link.png", value: "relaN1", dataKey: result[i].EntityName },
                                { text: "Flow", imageUrl: "/SMAT.UI/images/areachart.png", value: "flow", dataKey: result[i].EntityName },
