(function () {
    ...
    //  PanelBar
    ///////////////////////////////////////////////////////////////////////
    $.fn.smatPanelBar = function (config) {
        ...
        $.each($(this), function (n, value) {
            ...
            uiNode = new smat.PanelBar(config);
        });
        return uiNode;
    };
    /**
    ...
    smat.PanelBar.prototype = {
        ...
        init: function () {
            ...
            $(this.config.target).asmatPanelBar(uiConfig);

            this.uiControl = $(this.config.target).data("asmatPanelBar");
    ...
    // extend Node
    smat.globalObject.extend(smat.PanelBar, smat.UI);
})();