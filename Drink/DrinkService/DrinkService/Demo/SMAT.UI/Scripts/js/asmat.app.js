...
+function ($) {
  ...
  $(function(){
    ...
    fixVbox();
      ...
      // collapse nav
    $('[data-ride="collapse"] a').on('touchstart', function (e) {


        //alert(Modernizr.ios || Modernizr.android);
        //if (Modernizr.ios || Modernizr.android) {
        //    //alert(Modernizr.ios || Modernizr.android);
        //    $('<div class="menu-backdrop"/>').insertAfter($(this).parent()).on('click ', function (e) { $(".menu-backdrop").remove(); })
        //};
