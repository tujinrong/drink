(function () {
    ...
    smat.TextBox.prototype = {
        ...
        init: function () {
            ...
            } else if ($(this.config.target).hasClass("onlyDecimal")) {
                $(this.config.target).onlyDecimal();
            } else if ($(this.config.target).hasClass("onlyNumWidthHyphen")) {
                $(this.config.target).onlyNumWidthHyphen();
            }
            ...
            if (value == undefined) {
                ...
                if (this.config.print) {
                    $(this.config.target).attr("value",value);
                }
            }
        }, destroy: function () {
