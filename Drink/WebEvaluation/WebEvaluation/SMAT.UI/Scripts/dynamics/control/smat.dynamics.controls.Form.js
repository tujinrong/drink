...
(function () {
    ...
    smat.dynamics.Form.prototype = {
        ...
        init: function () {
            ...
            //link group
            uiConfig.groupType = this.config.page.config.groupType;
        ...
        getCustomPropertyConfig: function () {
            ...
            this.editPropertyConfig.push(
            {
                ...
                optionConfig: [
                    ...
                    {
                        group: 'action',
                        caption: 'noSuccessMsgShow',
                        type: 'DropDownList',
                        id: 'noSuccessMsgShow',
                        cmt: 'noSuccessMsgShow',
                        propType: "prop",
                        dataSource: [
                                {
                                    text: " ",
                    ...
                    {
                        group: 'action',
                        caption: 'getResultMsg',
                        type: 'Logic',
                        id: 'getResultMsg',
                        eventKey: 'form_getResultMsg',
                        cmt: 'getResultMsg',
                        propType: "prop"
                    }
                ]
