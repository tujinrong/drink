...
(function () {
    ...
    smat.dynamics.FormList.prototype = {
        ...
        init: function () {
            ...
            this.sizeTypeInput = $('<input />').appendTo(this.toolBar);
            ...
            this.sizeTypeInput.smatButtonGroup({
                dataTextField: "text",
                ...
                change: function (e) {
                    ...
                    self.page.body.addClass(self.sizeTypeInput.ui().value());
                }
            });
            ...
            var dataSource = [
                    ...
                    },
                    {
                        ...
                        text: "<i class='fa fa-search'></i>　" + "App",
                        value: "SimpleAppEmpty"
                    }
            ];
            ...
            smat.service.loadJosnData({
                ...
                success: function (result) {
                    ...
                    for (var key in result) {
                        if ($.Enumerable.From(datas).Where("$.EntityName == '" + result[key].EntityName + "'").ToArray().length > 0) {
                            if (result[key].EntityGroup == null) { result[key].EntityGroup = "" }
                            loadedEntitys.push(result[key])
                        }
                    }
            ...
            var groups = $.Enumerable.From(loadedEntitys).GroupBy("$.EntityGroup").ToArray();
            ...
            for (var i = 0; i < datas.length; i++) {
                ...
                item.imageUrl = smat.global.basePath + "/SMAT.UI/images/space.png"
                ...
                var entity = smat.service.getItemByKey(loadedEntitys, "EntityName", item.EntityName);
                var gname = "other";
                if (entity && entity.EntityGroup) gname = entity.EntityGroup;
                if (!gname) gname = "other";
                var g = smat.service.getItemByKey(treeDs, "text", gname);
                if (!g) {
                    var g = {
                        text: gname,
                        imageUrl: smat.global.basePath + "/SMAT.UI/images/box.png",
                ...
                var entityItem = smat.service.getItemByKey(g.items, "EntityName", item.EntityName);
                if (entityItem == undefined) {
                    ...
                    entityItem.imageUrl = smat.global.basePath + "/SMAT.UI/images/folder.png"
                    g.items.push(entityItem);
                }
                entityItem.items.push(item);
            }

            this.treeview.setDataSource(treeDs);
            this.treeview.expand(this.treeviewBox.children('ul').children('.s-item'));
            ...
            if (formName == undefined) {
                ...
                if (templateType == "SimpleAppEmpty") {

                    this.sizeTypeInput.ui().value("s-screen-phone-v");

                    this.page = smat.dynamics.openAppPage({
                        projID: projID,
                        formName: formName,
                    ...
                    this.sizeTypeInput.ui().value("s-screen-pc");
                ...
                this.page.body.addClass(this.sizeTypeInput.ui().value());
        ...
        getNewFormName: function (handle) {
            ...
            $('<div class="row" style="margin:8px 0;"><div class=" form-group" ><label class="control-label input-s-sm text-right" style="margin-right:5px;">種別</label><input id="_NEW_Form_Entity" class="input-s" style="width:300px;"></div></div>').appendTo(ebox);
            $('<div class="row" id="newNameInput_row" style="margin:8px 0;"><div class=" form-group" ><label class="control-label input-s-sm text-right" style="margin-right:5px;">' + 'CD' + '</label><input id="_FilterName_NEW" class="s-textbox input-s" style="width:300px;" ></div></div>').appendTo(ebox);
            ...
            if (templateType == "SimpleAppEmpty") {
                isMobile = true;
                this.designer = designerBox.smatDynamicsdAppDesigner({
                    projID: projID,
                    formName: formName,
                    formDesc: formDesc,
                    //hideToolBar:true,
            ...
            this.saveBtn.hide();
            this.sizeTypeInput.ui().visible(false);
            this.designBtn.hide();
            ...
            if (this.pageItem != null) {
                ...
                this.sizeTypeInput.ui().visible(true);
                this.designBtn.show();
                //this.savForeBtn.show();
                this.delBtn.show();
            }
