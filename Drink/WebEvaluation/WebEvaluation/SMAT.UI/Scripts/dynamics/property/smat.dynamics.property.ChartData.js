...
(function () {
    ...
    smat.dynamics.property.ChartData.prototype = {
        ...
        init: function () {
            ...
            this.X_dataType = this.box.find('#X_dataType');
            ...
            smat.service.openForm({
                ...
                afterClose: function (result) {
                    ...
                    self.getFormData("XDataType", self.X_dataType);
            ...
            this.X_dataType.smatDropDownList({
                codeKind: "ChartDataType",
                emptyItem: false,
                change: function (e) {
                    if (self.X_dataType.ui().value() == "Date") {
                        self.X_format.ui().setDataSource([
                                { text: smat.service.optionSet("DyOptionFormat.YMD"), value: "YMD" },
                                { text: smat.service.optionSet("DyOptionFormat.YM"), value: "YM" },
                                { text: smat.service.optionSet("DyOptionFormat.Y"), value: "Y" }
                        ]);
                    } else {
                        self.X_format.ui().setDataSource([]);
                    }
            ...
            this.setFormData("XDataType", this.X_dataType);
            ...
            //
            if (this.X_dataType.ui().value() == "Date") {
                this.X_format.ui().setDataSource([
                        { text: smat.service.optionSet("DyOptionFormat.YMD"), value: "YMD" },
                        { text: smat.service.optionSet("DyOptionFormat.YM"), value: "YM" },
                        { text: smat.service.optionSet("DyOptionFormat.Y"), value: "Y" }
                ]);
...
+ '    </div>'
+ '    <div  style="margin: 0;padding: 0;height: 100%;width:720px;float:left;">'
...
+ '                <label class="control-label text-right" style="width:60px; margin-right:5px;">' + smat.service.optionSet("DyOptionText.DataType") + '</label><input id="X_dataType" class="" style=" width:100px;" />'
+ '                    <label class="control-label text-right" style="width:80px; margin-right:5px;">' + smat.service.optionSet("DyOptionText.Format") + '</label><input id="X_format" class="" style="width:180px;">'
+ '                    </div></div>'
...
+ '                    <label class="control-label text-right" style="width:60px; margin-right:5px;">' + smat.service.optionSet("DyOptionText.Increasing") + '</label><input id="_increasing" class="" style="width:100px;">'
+ '                    <label class="control-label text-right" style="width:80px; margin-right:5px;">' + smat.service.optionSet("DyOptionText.Format") + '</label><input id="Y_format" class="" style="width:180px;">'
+ '                </div></div>'
+ '                <div class="row  data-row" style="margin:2px 0;position: relative;"><div class=" form-group">'
...
+ '                    <label class="control-label text-right" style="width:60px; margin-right:5px;">' + smat.service.optionSet("DyOptionText.Display") + '</label><input id="legend_visible" class="" style="width:100px;">'
+ '                    <label class="control-label text-right" style="width:80px; margin-right:5px;">' + smat.service.optionSet("DyOptionText.Position") + '</label><input id="legend_position" class="" style="width:180px;"/>'
+ '             </div></div>'
+ '            </div>'
+ '        </div>'
