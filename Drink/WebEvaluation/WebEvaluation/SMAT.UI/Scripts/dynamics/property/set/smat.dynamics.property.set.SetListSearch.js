...
(function () {
    ...
    smat.dynamics.property.set.SetListSearch.prototype = {
        getPropertiesConfig: function () {
                    ...
                    success: function (result) {
                        ...
                        if (smat.dynamics.isUser()) {
                            if (smat.dynamics.analysisConfig && smat.dynamics.analysisConfig.getUserEntityList) {
                                datas = smat.dynamics.analysisConfig.getUserEntityList(self, result);
                            } else {
            ...
            //
            if (this.config.page.config.title && self.config.page.config.designer.titlePane) {
            ...
            var entityDs = self.config.page.entityNames;
            if (smat.dynamics.analysisConfig && smat.dynamics.analysisConfig.adjustEntityDs) {
                smat.dynamics.analysisConfig.adjustEntityDs(entityDs);
            }
            ...
            var baseGroup = {
                ...
                items: [
                            ...
                            ,
                            {
                                ...
                                onChange: function (ev) {
                                    self.config.page.config.designer.selectedSearchIndex = self.config.page.config.designer.template.activateTab.tools[0].treebox.find(".s-state-selected").closest(".s-item").index();
            ...
            if (!this.config.page.groupNames || this.config.page.groupNames.length > 0) {
                ...
                if (smat.dynamics.analysisConfig && smat.dynamics.analysisConfig.getGroupNamesFilter) {
                    fs = smat.dynamics.analysisConfig.getGroupNamesFilter(this, createdByValue)
                }
