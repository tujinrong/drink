...
(function () {
    ...
    smat.dynamics.template.SimpleMasterEmpty = function (config) {
        //默认属性
        this.setConfig({
            page: undefined,
            type: "SimpleMasterEditEmpty"
    ...
    smat.dynamics.template.SimpleMasterEmpty.prototype = {
        /**
          * 初期化
          * @name init
...
+ "\n\}",
    ...
    // extend Node
    smat.globalObject.extend(smat.dynamics.template.SimpleMasterEmpty, smat.dynamics.template.BaseTemplate);
