...
(function() {
    ...
    //0：开始节点，99：结束节点，1：人工节点，2：决策节点，3：分支节点，4：动态分支节点，5：聚合节点，6：动作节点，7：分发节点
    smat.dynamics.diagram.FlowTypeSetting = {
        "0": {
            nodeIcon: smat.global.basePath + "/SMAT.UI/images/flow_icon/node_Start.png",
            nodeDesc: "start"
        },
        "1": {
            nodeIcon: smat.global.basePath + "/SMAT.UI/images/flow_icon/node_users.png",
            nodeDesc: "human"
        },
        "2": {
            nodeIcon: smat.global.basePath + "/SMAT.UI/images/flow_icon/node_google keep.png",
            nodeDesc: "decision"
        },
        "3": {
            nodeIcon: smat.global.basePath + "/SMAT.UI/images/flow_icon/node_sharethis.png",
            nodeDesc: "branch"
        },
        "5": {
            nodeIcon: smat.global.basePath + "/SMAT.UI/images/flow_icon/node_joomla.png",
            nodeDesc: "polymerization"
        },
        "7": {
            nodeIcon: smat.global.basePath + "/SMAT.UI/images/flow_icon/node_group.png",
            nodeDesc: "group"
        },
        "99": {
            nodeIcon: smat.global.basePath + "/SMAT.UI/images/flow_icon/node_PlayerStop.png",
            nodeDesc: "human"
        }
    };
