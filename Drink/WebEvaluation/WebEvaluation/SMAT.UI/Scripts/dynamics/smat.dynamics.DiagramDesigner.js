...
(function () {
    ...
    //  Desinger
    ///////////////////////////////////////////////////////////////////////
    $.fn.smatDynamicsdDiagramDesigner = function (config) {
        ...
        $.each($(this), function (n, value) {
            ...
            uiNode = new smat.dynamics.DiagramDesigner(config);
        });
        return uiNode;
    };

    smat.dynamics.DiagramDesigner = function (config) {
        //默认属性
        this.setConfig({
            target: undefined,
            toolPanelWidth: "80px"
    ...
    smat.dynamics.DiagramDesigner.prototype = {
        /**
          * 初期化
          * @name init
        ...
        , getNewName: function (handle) {
            ...
            this.page = new smat.dynamics.diagram.FlowStage({
                projID: this.mainProjID,
                entityName: this.mainEntityName,
        ...
        initDom: function () {
            ...
            this.cancelBtn = $('<button class="btn-danger" style="margin-left:20px;">' + smat.service.optionSet("DyOptionText.Close") + '</button>').appendTo(this.topRow);
    ...
    // extend Node
    smat.globalObject.extend(smat.dynamics.DiagramDesigner, smat.dynamics.Element);
