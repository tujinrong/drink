  ...
  var EventHandler = function () {
    ...
    var commands = {
      ...
      fullscreen: function (oLayoutInfo) {
        ...
        if (isFullscreen) {
            $('body').children('.navbar-fixed-top').hide();
          ...
          $scrollbar.css('overflow', 'hidden');
            ...
            $('body').children('.navbar-fixed-top').show();
          $window.off('resize');
          resize({
            w: options.width || '',
     ...
     * @param {Event} event
     */
    var hPasteClipboardNoHtml = function (event) {
        debugger;
        var t = "";
        var clipboardData;
        if (window.clipboardData) {
            ...
            if (clipboardData.files.length > 0) {
                alert("クリップボードは、写真やドキュメントが含まれている、貼り付けることはできません。");
                return false;
            } else {
                t = "<span>" + clipboardData.getData('text') + "</span>";
            }
    ...
    this.attach = function (oLayoutInfo, options) {
      ...
      if (options.pasteNoHtml == true) {
          oLayoutInfo.editable.on('paste', hPasteClipboardNoHtml);
      } else {
  ...
  var Renderer = function () {
    ...
    var tplButtonInfo = {
      ...
      fontsize: function (lang, options) {
        ...
        var sLabel = '<span class="note-current-fontsize">18</span>';
        return tplButton(sLabel, {
          title: lang.font.size,
          dropdown: '<ul class="dropdown-menu">' + items + '</ul>'
        });
      },
      fontColor: function (lang) {
          var colorButtonLabel = '<i class="fa fa-font icon-font" style="color:black;background-color:#ffffff;"></i>';
          ...
          var dropdown = '<ul class="dropdown-menu" style="min-width: 172px;">' +
                           '<li>' +
                             '<div class="btn-group">' +
                               '<div class="note-palette-title">' + lang.color.foreground + '</div>' +
                               '<div class="note-color-reset" data-event="foreColor" data-value="#333333" title="' + lang.color.reset + '">' +
      ...
      color: function (lang) {
        var colorButtonLabel = '<i class="fa fa-font icon-font" style="color:black;background-color:#FFFF00;"></i>';
        var colorButton = tplButton(colorButtonLabel, {
          className: 'note-recent-color',
          title: lang.color.recent,
          event: 'color',
          value: '{"backColor":"#FFFF00"}'
        });
